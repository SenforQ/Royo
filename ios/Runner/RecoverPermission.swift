...
class RecoverPermission {
    //: static let shared = AppPermissionTool()
    static let shared = RecoverPermission()

    /// 获取麦克风权限
    //: func requestMicPermission(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    func indicatorBlock(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    ...
    func of(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
        //: if #available(iOS 14, *) {
        if #available(iOS 14, *) {
    ...
    func agent(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
